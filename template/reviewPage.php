        ...
        <main class="container my-3">
            <header class="d-flex flex-row ">
                ...
                <div class="col-5 flex-column">
                   <a href="<?php echo "/Spotlight/profile.php?user=" . $templateParams["username"]?>" class="label-large" style="text-decoration:none;outline:none;color:black"> <p class="label-large ms-3"><?php echo $templateParams["username"]?></p> </a>
            ...
            <?php echo $templateParams["number_of_likes"]?>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" data-type="thumbs-up" fill="currentColor" class="bi bi-hand-thumbs-up mr-2 likes" viewBox="0 0 16 16">
            ...
            <?php echo $templateParams["number_of_dislikes"]?>
