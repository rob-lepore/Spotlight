<div class="mt-2">
    <header class="d-flex justify-content-between">
        <a title="go to user page" href=<?php echo "./profile.php?user=" . $postData["username"] ?> style="text-decoration: inherit; color:inherit">
        ...
        <header>
            ...
            <div class="d-flex justify-content-between mt-4 mx-2 mb-2">
                <div class="d-flex" style="gap: 1rem">
                    <div>
                        <a title="toggle like to post" onclick=<?php echo "toggleLike(" . $postData["id"] . ")"?> id= <?php echo "heartIcon" . $postData["id"] ?> >
                        ...
                        <span id=<?php echo "likesNumber" . $postData["id"] ?>><?php echo count($postData["likes"]) ?></span>
                    </div>
                    <a title="go to post page" href=<?php echo"./post.php?id=" . $postData["id"] ?> style="color: inherit">
                ...
                <a title="listen on spotify" href=<?php echo $postData["track"]->external_urls->spotify ?> class="sl-btn text-spotify elevation-1 text-small" target="_blank" style="text-decoration:none;">
                    listen on Spotify
