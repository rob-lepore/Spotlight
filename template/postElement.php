<div class="mt-2">
    <header class="d-flex justify-content-between">
        <a href=<?php echo "./profile.php?user=" . $postData["username"] ?> style="text-decoration: inherit; color:inherit">
        ...
        <header>
            ...
            <div class="d-flex justify-content-between mt-4 mx-2 mb-2">
                <div class="d-flex" style="gap: 1rem">
                    <div>
                        <a onclick=<?php echo "toggleLike(" . $postData["id"] . ")"?> id= <?php echo "heartIcon" . $postData["id"] ?> >
