...
<body theme="<?php echo $_COOKIE["theme"] ?>">
    ...
    <header class="container my-2">
        <a title="go to home page" href="./" style="color:inherit">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
            </svg>
        </a>
        <a title="go to user profile" href=<?php echo "./profile.php?user=" . $templateParams["username"] ?> style="color:inherit; text-decoration:none">
        ...
        <header class="mb-3">
            ...
            <div class="d-flex justify-content-between mt-4">
                <div class="d-flex" style="gap: 1rem">
                    ...
                    <a title="open comment form" onclick="toggleForm()">
