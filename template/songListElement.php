<div class='d-flex my-2 surface align-items-center'>
    ...
    <div class="d-flex flex-row justify-content-evenly w-25" style="min-width: 7rem;">
        <a href=<?php echo $templateParams["newPostUrl"];echo $templateParams["trackId"] ?> style="color: var(--text-on-surface)">
        ...
        <a href= <?php echo $templateParams["trackUrl"] ?> class="text-spotify" target="_blank">
