<div class="alert alert-dismissible fade show surface" id="<?php echo $templateParams["id"]?>" style="border-radius:1rem;" role="alert">
    ...
    <button type="button" class="btn-close ms-auto close" data-bs-dismiss="alert" aria-albel="Close"></button>
        ...
        <img src="<?php echo UPLOAD_DIR.$templateParams["source_profile_pic"]?>" style="border-radius:100%;width:4rem;object-fit: cover;" alt="profile foto of the user"/>
        ...
        ?>" class="text-decoration-none text-reset link-ref"><p class="ms-3 text-medium" ><?php 
            if($templateParams["type"] == "Mood"){
                ...
                echo $templateParams["isLike"]?'has liked your post':"has commented to your post";
            }
        ?></p></a>
    </div>
